...
class CaptionGenerator(object):
    ...
    def beam_search(self, rnn_input, initial_state=None):
        ...
        def get_topk_words(embeddings, state):
            ...
            with torch.no_grad(): # 确保RNN和分类器的前向也在no_grad中
        ...
        for _ in range(self.max_caption_length - 1):
            ...
            if rnn_input.is_cuda:
                ...
                with torch.no_grad(): # 同样，这里的嵌入和RNN前向也在此上下文管理器中
                    input_feed = input_feed # input_feed 已经是 LongTensor，不需要 Variable
